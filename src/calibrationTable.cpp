...
void calibrationTable::setY(vector<double> _y) { y = _y; };
void calibrationTable::setX(vector<double> _x) { x = _x; };
...
void calibrationTable::setMethod(int _spline_method) {
...
calibrationTable::calibrationTable() { flag = false; }
