 ...
 */
inline void natural_spline_C(int n, double *x, double *y, double *b, double *c, double *d)
{
 ...
 */
inline void spline_eval_C(int *method, int *nu, double *u, double *v,
...
inline void natural_spline(vector<double>x, vector<double> y, vector<double>& b,vector<double>& c,vector<double>& d)
{
    int nm1, i;
    double t;
    int n=x.size();
...
inline void spline_eval(int method, double* u,int nSize,
